...
module.exports = {
    ...
    CreateAnUserValidator: [
        ...
        body("password")
            ...
            .withMessage(
                "password phai co it nhat 8 ki tu trong do co it nhat 1 ki tu chu hoa, 1 ki tu chu thuong,1 ki tu so va 1 ki tu dac biet",
            ),
        body("role")
            .notEmpty()
        ...
        body("avatarUrl")
            .optional()
            .isArray()
            .withMessage("avatarURl pahi la 1 mang"),
